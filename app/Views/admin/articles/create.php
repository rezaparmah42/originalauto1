<?php
$title = 'افزودن مقاله | ' . SITE_NAME;
$description = 'افزودن مقاله جدید در پنل مدیریت اورجینال شرق.';
$canonical = SITE_URL . '/admin/articles/create';
...
<div class="container" style="padding: 2rem 1rem 3rem; max-width: 900px;">
    <h1>افزودن مقاله</h1>
    <p>یک مقاله جدید با تنظیمات سئو ایجاد کنید.</p>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div style="display:flex; gap:0.7rem; flex-wrap:wrap;">
            <button type="submit" class="btn-primary">ثبت مقاله</button>
