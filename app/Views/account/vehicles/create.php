<?php
$title = 'ثبت خودرو | ' . SITE_NAME;
$description = 'ثبت خودرو جدید در پروفایل مشتری.';
$canonical = SITE_URL . '/account/vehicles/create';
...
<div class="container" style="padding: 2rem 1rem 3rem; max-width: 800px;">
    <h1>ثبت خودرو</h1>
    <p>اطلاعات خودرو را برای پیگیری تعمیرات و نگهداری وارد کنید.</p>
    ...
    <form method="post">
        ...
        <div style="display:flex; gap:0.7rem; flex-wrap:wrap;">
            <button type="submit" class="btn-primary">ثبت خودرو</button>
